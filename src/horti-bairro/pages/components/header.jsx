...
const Header = () => {
  ...
  return (
    <header className="bg-[#97ad7f] fixed top-0 left-0 w-full max-h-[10vh] flex items-center px-5 py-2">
      <HamburgerMenu isOpen={isOpen} setIsOpen={setIsOpen} />
      <h1 className="text-2xl font-bold w-[30vw] hidden lg:block">HORTI-BAIRRO</h1>
      ...
      {isOpen && (
        <nav className="absolute top-12 left-5 w-48 bg-[#f2efeb] shadow-lg rounded-lg transition-transform">
